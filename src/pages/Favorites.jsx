    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        ...
        >
          ...
          <h1 className="text-4xl font-bold text-gray-800 mb-4">Your Favorites is Empty</h1>
          <p className="text-gray-600 mb-8">Add some beautiful jewelry to your favorites!</p>
          <Link
            to="/shop"
              ...
              <Link to={`/product/${product.id}`}>
                <div className="h-64 bg-gradient-to-br from-gold to-dark-gold flex items-center justify-center relative">
                  <span className="text-white text-8xl">
                    {/* You can add logic here to show different emojis based on category */}
                    💍
                  </span>
                </div>
              </Link>
